...
const natData = {
    ...
    description: `Nat writes fiction, teaches storytelling, and designs games. They are faculty in Pratt Institute's Game Design & Interactive Media program, and teach interactive fiction for <a href="https://one-story.com/">One Story</a>. Nat's poetry, fiction, and nonfiction have appeared in <i>Vol. 1 Brooklyn, Cartridge Lit, Autostraddle, Bodega, Blackbird, Kenyon Review Online,</i> and elsewhere. A co-founder of <a href="https://scryptidgames.com/">Scryptid Games</a>, Nat's published roleplaying games include Business Wizards, Horseshoe Academy, Ball of the Wild, Adventurer's Respite, and Gods of Rock. New titles from Scryptid Games and 9th Level Games are forthcoming in 2025.`
};
